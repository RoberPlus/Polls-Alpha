                ...
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('password.update') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="p-3 bg-gray-100 roundend form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password-confirm" type="password" class="p-3 bg-gray-100 roundend form-input w-full" name="password_confirmation"  autocomplete="new-password">
                        </div>
