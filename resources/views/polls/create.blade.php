                    ...
                    <form class="py-8 px-5" method="POST" action="{{ route('polls.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="title" type="text"
                                ...
                                name="title" value="{{ old('title') }}" autocomplete="title" placeholder="Agrega un titulo a tu votacion" autofocus>
        ...
        $(document).ready(function() {
            ...
            $('#add').click(function() {
                ...
                $('#dynamic_field').append('<tr id="row' + i +
                    ...
                    '" class="p-3 bg-gray-100 roundend form-input w-full @error('option') border-red-500 border  @enderror" /></td><td><button type="button" name="remove" id="' +
                    i + '" class="border border-red-500 bg-red-500 text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-red-600 focus:outline-none focus:shadow-outline btn_remove">X</button></td></tr>');
            });
